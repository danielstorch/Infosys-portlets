...
import de.hska.wi.awp.datasource.infosys.service.Geplante_arbeitLocalService;
...
/**
 * Provides the base implementation for the geplante_arbeit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.Geplante_arbeitLocalServiceImpl}.
 * </p>
 *
 * @author Daniel Storch
 * @see de.hska.wi.awp.datasource.infosys.service.impl.Geplante_arbeitLocalServiceImpl
 * @see de.hska.wi.awp.datasource.infosys.service.Geplante_arbeitLocalServiceUtil
 * @generated
 */
public abstract class Geplante_arbeitLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements Geplante_arbeitLocalService,
        IdentifiableBean {
    ...
    private Geplante_arbeitLocalServiceClpInvoker _clpInvoker = new Geplante_arbeitLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.Geplante_arbeitLocalServiceUtil} to access the geplante_arbeit local service.
     */
    ...
    @Override
    public Geplante_arbeit addGeplante_arbeit(Geplante_arbeit geplante_arbeit)
        throws SystemException {
        geplante_arbeit.setNew(true);

        return geplante_arbeitPersistence.update(geplante_arbeit);
    }
     ...
     */
    @Override
    public Geplante_arbeit createGeplante_arbeit(long id) {
        return geplante_arbeitPersistence.create(id);
    }
    ...
    @Override
    public Geplante_arbeit deleteGeplante_arbeit(long id)
        throws PortalException, SystemException {
        return geplante_arbeitPersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Geplante_arbeit deleteGeplante_arbeit(
        Geplante_arbeit geplante_arbeit) throws SystemException {
        return geplante_arbeitPersistence.remove(geplante_arbeit);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Geplante_arbeit.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return geplante_arbeitPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return geplante_arbeitPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Geplante_arbeit fetchGeplante_arbeit(long id)
        throws SystemException {
        return geplante_arbeitPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Geplante_arbeit getGeplante_arbeit(long id)
        throws PortalException, SystemException {
        return geplante_arbeitPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return geplante_arbeitPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Geplante_arbeit> getGeplante_arbeits(int start, int end)
        throws SystemException {
        return geplante_arbeitPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getGeplante_arbeitsCount() throws SystemException {
        return geplante_arbeitPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Geplante_arbeit updateGeplante_arbeit(
        Geplante_arbeit geplante_arbeit) throws SystemException {
        return geplante_arbeitPersistence.update(geplante_arbeit);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("de.hska.wi.awp.datasource.infosys.model.Geplante_arbeit",
            geplante_arbeitLocalService);
    }
