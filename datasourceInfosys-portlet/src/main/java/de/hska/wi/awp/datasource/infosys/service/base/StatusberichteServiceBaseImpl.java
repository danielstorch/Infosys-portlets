...
import de.hska.wi.awp.datasource.infosys.service.StatusberichteService;
...
/**
 * Provides the base implementation for the statusberichte remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.StatusberichteServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class StatusberichteServiceBaseImpl extends BaseServiceImpl
    implements StatusberichteService, IdentifiableBean {
    ...
    private StatusberichteServiceClpInvoker _clpInvoker = new StatusberichteServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.StatusberichteServiceUtil} to access the statusberichte remote service.
     */
