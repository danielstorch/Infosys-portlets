...
import de.hska.wi.awp.datasource.infosys.service.RolleService;
...
/**
 * Provides the base implementation for the rolle remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.RolleServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class RolleServiceBaseImpl extends BaseServiceImpl
    implements RolleService, IdentifiableBean {
    ...
    private RolleServiceClpInvoker _clpInvoker = new RolleServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.RolleServiceUtil} to access the rolle remote service.
     */
