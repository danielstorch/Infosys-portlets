...
/**
 * Provides the base implementation for the rolle local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.RolleLocalServiceImpl}.
 * </p>
 *
 * @author Daniel Storch
 * @see de.hska.wi.awp.datasource.infosys.service.impl.RolleLocalServiceImpl
 * @see de.hska.wi.awp.datasource.infosys.service.RolleLocalServiceUtil
 * @generated
 */
public abstract class RolleLocalServiceBaseImpl extends BaseLocalServiceImpl
    ...
    private RolleLocalServiceClpInvoker _clpInvoker = new RolleLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.RolleLocalServiceUtil} to access the rolle local service.
     */
    ...
    @Override
    public Rolle addRolle(Rolle rolle) throws SystemException {
        rolle.setNew(true);

        return rollePersistence.update(rolle);
    }
     ...
     */
    @Override
    public Rolle createRolle(long id) {
        return rollePersistence.create(id);
    }
    ...
    @Override
    public Rolle deleteRolle(long id) throws PortalException, SystemException {
        return rollePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Rolle deleteRolle(Rolle rolle) throws SystemException {
        return rollePersistence.remove(rolle);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Rolle.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return rollePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return rollePersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return rollePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return rollePersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Rolle fetchRolle(long id) throws SystemException {
        return rollePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Rolle getRolle(long id) throws PortalException, SystemException {
        return rollePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return rollePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Rolle> getRolles(int start, int end) throws SystemException {
        return rollePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getRollesCount() throws SystemException {
        return rollePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Rolle updateRolle(Rolle rolle) throws SystemException {
        return rollePersistence.update(rolle);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("de.hska.wi.awp.datasource.infosys.model.Rolle",
            rolleLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = rollePersistence.getDataSource();
