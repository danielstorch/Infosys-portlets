...
import de.hska.wi.awp.datasource.infosys.service.AllgemeinesService;
...
/**
 * Provides the base implementation for the allgemeines remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.AllgemeinesServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AllgemeinesServiceBaseImpl extends BaseServiceImpl
    implements AllgemeinesService, IdentifiableBean {
    ...
    private AllgemeinesServiceClpInvoker _clpInvoker = new AllgemeinesServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.AllgemeinesServiceUtil} to access the allgemeines remote service.
     */
