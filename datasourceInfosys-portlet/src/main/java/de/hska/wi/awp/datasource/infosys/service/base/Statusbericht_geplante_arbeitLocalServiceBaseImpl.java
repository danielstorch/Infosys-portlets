...
import de.hska.wi.awp.datasource.infosys.service.Statusbericht_geplante_arbeitLocalService;
...
/**
 * Provides the base implementation for the statusbericht_geplante_arbeit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.Statusbericht_geplante_arbeitLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class Statusbericht_geplante_arbeitLocalServiceBaseImpl
    extends BaseLocalServiceImpl
    implements Statusbericht_geplante_arbeitLocalService, IdentifiableBean {
    ...
    private Statusbericht_geplante_arbeitLocalServiceClpInvoker _clpInvoker = new Statusbericht_geplante_arbeitLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.Statusbericht_geplante_arbeitLocalServiceUtil} to access the statusbericht_geplante_arbeit local service.
     */
    ...
    @Override
    public Statusbericht_geplante_arbeit addStatusbericht_geplante_arbeit(
        Statusbericht_geplante_arbeit statusbericht_geplante_arbeit)
        throws SystemException {
        statusbericht_geplante_arbeit.setNew(true);

        return statusbericht_geplante_arbeitPersistence.update(statusbericht_geplante_arbeit);
    }
     ...
     */
    @Override
    public Statusbericht_geplante_arbeit createStatusbericht_geplante_arbeit(
        long id) {
        return statusbericht_geplante_arbeitPersistence.create(id);
    }
    ...
    @Override
    public Statusbericht_geplante_arbeit deleteStatusbericht_geplante_arbeit(
        long id) throws PortalException, SystemException {
        return statusbericht_geplante_arbeitPersistence.remove(id);
    }
    ...
    public Statusbericht_geplante_arbeit deleteStatusbericht_geplante_arbeit(
        Statusbericht_geplante_arbeit statusbericht_geplante_arbeit)
        throws SystemException {
        return statusbericht_geplante_arbeitPersistence.remove(statusbericht_geplante_arbeit);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Statusbericht_geplante_arbeit.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return statusbericht_geplante_arbeitPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return statusbericht_geplante_arbeitPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Statusbericht_geplante_arbeit fetchStatusbericht_geplante_arbeit(
        long id) throws SystemException {
        return statusbericht_geplante_arbeitPersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Statusbericht_geplante_arbeit getStatusbericht_geplante_arbeit(
        long id) throws PortalException, SystemException {
        return statusbericht_geplante_arbeitPersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return statusbericht_geplante_arbeitPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Statusbericht_geplante_arbeit> getStatusbericht_geplante_arbeits(
        int start, int end) throws SystemException {
        return statusbericht_geplante_arbeitPersistence.findAll(start, end);
    }
    ...
    public int getStatusbericht_geplante_arbeitsCount()
        throws SystemException {
        return statusbericht_geplante_arbeitPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Statusbericht_geplante_arbeit updateStatusbericht_geplante_arbeit(
        Statusbericht_geplante_arbeit statusbericht_geplante_arbeit)
        throws SystemException {
        return statusbericht_geplante_arbeitPersistence.update(statusbericht_geplante_arbeit);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("de.hska.wi.awp.datasource.infosys.model.Statusbericht_geplante_arbeit",
            statusbericht_geplante_arbeitLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = statusbericht_geplante_arbeitPersistence.getDataSource();
