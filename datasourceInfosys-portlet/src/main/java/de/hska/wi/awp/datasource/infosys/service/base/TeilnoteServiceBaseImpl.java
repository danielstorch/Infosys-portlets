...
import de.hska.wi.awp.datasource.infosys.service.TeilnoteService;
...
/**
 * Provides the base implementation for the teilnote remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.TeilnoteServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class TeilnoteServiceBaseImpl extends BaseServiceImpl
    implements TeilnoteService, IdentifiableBean {
    ...
    private TeilnoteServiceClpInvoker _clpInvoker = new TeilnoteServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.TeilnoteServiceUtil} to access the teilnote remote service.
     */
