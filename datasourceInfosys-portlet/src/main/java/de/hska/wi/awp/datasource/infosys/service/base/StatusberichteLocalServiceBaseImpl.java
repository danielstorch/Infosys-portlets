...
import de.hska.wi.awp.datasource.infosys.service.StatusberichteLocalService;
...
/**
 * Provides the base implementation for the statusberichte local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.hska.wi.awp.datasource.infosys.service.impl.StatusberichteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class StatusberichteLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements StatusberichteLocalService,
        IdentifiableBean {
    ...
    private StatusberichteLocalServiceClpInvoker _clpInvoker = new StatusberichteLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link de.hska.wi.awp.datasource.infosys.service.StatusberichteLocalServiceUtil} to access the statusberichte local service.
     */
    ...
    @Override
    public Statusberichte addStatusberichte(Statusberichte statusberichte)
        throws SystemException {
        statusberichte.setNew(true);

        return statusberichtePersistence.update(statusberichte);
    }
     ...
     */
    @Override
    public Statusberichte createStatusberichte(long id) {
        return statusberichtePersistence.create(id);
    }
    ...
    @Override
    public Statusberichte deleteStatusberichte(long id)
        throws PortalException, SystemException {
        return statusberichtePersistence.remove(id);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Statusberichte deleteStatusberichte(Statusberichte statusberichte)
        throws SystemException {
        return statusberichtePersistence.remove(statusberichte);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Statusberichte.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return statusberichtePersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return statusberichtePersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public Statusberichte fetchStatusberichte(long id)
        throws SystemException {
        return statusberichtePersistence.fetchByPrimaryKey(id);
    }
     ...
     */
    @Override
    public Statusberichte getStatusberichte(long id)
        throws PortalException, SystemException {
        return statusberichtePersistence.findByPrimaryKey(id);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return statusberichtePersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Statusberichte> getStatusberichtes(int start, int end)
        throws SystemException {
        return statusberichtePersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getStatusberichtesCount() throws SystemException {
        return statusberichtePersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Statusberichte updateStatusberichte(Statusberichte statusberichte)
        throws SystemException {
        return statusberichtePersistence.update(statusberichte);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("de.hska.wi.awp.datasource.infosys.model.Statusberichte",
            statusberichteLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = statusberichtePersistence.getDataSource();
