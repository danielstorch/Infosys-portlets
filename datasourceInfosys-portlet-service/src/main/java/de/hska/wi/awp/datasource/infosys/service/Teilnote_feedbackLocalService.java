...
/**
 * Provides the local service interface for Teilnote_feedback. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Daniel Storch
 * @see Teilnote_feedbackLocalServiceUtil
...
public interface Teilnote_feedbackLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Teilnote_feedbackLocalServiceUtil} to access the teilnote_feedback local service. Add custom service methods to {@link de.hska.wi.awp.datasource.infosys.service.impl.Teilnote_feedbackLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
