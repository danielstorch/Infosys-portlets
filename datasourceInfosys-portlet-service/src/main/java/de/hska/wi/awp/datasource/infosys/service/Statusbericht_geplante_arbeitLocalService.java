...
/**
 * Provides the local service interface for Statusbericht_geplante_arbeit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Daniel Storch
 * @see Statusbericht_geplante_arbeitLocalServiceUtil
...
public interface Statusbericht_geplante_arbeitLocalService
    extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Statusbericht_geplante_arbeitLocalServiceUtil} to access the statusbericht_geplante_arbeit local service. Add custom service methods to {@link de.hska.wi.awp.datasource.infosys.service.impl.Statusbericht_geplante_arbeitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
