 ...
 * @generated
 */
public class AllgemeinesLocalServiceClp implements AllgemeinesLocalService {
    ...
    public AllgemeinesLocalServiceClp(
    ...
    public de.hska.wi.awp.datasource.infosys.model.Allgemeines addAllgemeines(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(allgemeines) });
        } catch (Throwable t) {
        ...
        return (de.hska.wi.awp.datasource.infosys.model.Allgemeines) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.infosys.model.Allgemeines> getAllgemeineses(
        ...
        return (java.util.List<de.hska.wi.awp.datasource.infosys.model.Allgemeines>) ClpSerializer.translateOutput(returnObj);
    }
