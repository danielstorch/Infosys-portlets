 ...
 * @generated
 */
public class TeilnoteLocalServiceClp implements TeilnoteLocalService {
    ...
    public TeilnoteLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public de.hska.wi.awp.datasource.infosys.model.Teilnote addTeilnote(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(teilnote) });
        } catch (Throwable t) {
        ...
        return (de.hska.wi.awp.datasource.infosys.model.Teilnote) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.infosys.model.Teilnote> getTeilnotes(
        ...
        return (java.util.List<de.hska.wi.awp.datasource.infosys.model.Teilnote>) ClpSerializer.translateOutput(returnObj);
    }
