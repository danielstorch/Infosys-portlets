...
public class ProjectWrapper implements Project, ModelWrapper<Project> {
    ...
    */
    @Override
    public java.lang.String getProjecthskaId() {
        return _project.getProjecthskaId();
    }
    ...
    */
    @Override
    public void setProjecthskaId(java.lang.String projecthskaId) {
        _project.setProjecthskaId(projecthskaId);
    }
    ...
    */
    ...
    @Override
    public com.liferay.portal.model.CacheModel<de.hska.wi.awp.datasource.infosys.model.Project> toCacheModel() {
