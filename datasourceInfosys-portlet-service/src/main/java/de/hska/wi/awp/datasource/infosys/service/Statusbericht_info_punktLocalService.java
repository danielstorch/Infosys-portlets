...
/**
 * Provides the local service interface for Statusbericht_info_punkt. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Daniel Storch
 * @see Statusbericht_info_punktLocalServiceUtil
...
public interface Statusbericht_info_punktLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Statusbericht_info_punktLocalServiceUtil} to access the statusbericht_info_punkt local service. Add custom service methods to {@link de.hska.wi.awp.datasource.infosys.service.impl.Statusbericht_info_punktLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
