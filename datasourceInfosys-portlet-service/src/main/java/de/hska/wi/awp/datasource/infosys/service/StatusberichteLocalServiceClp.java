 ...
 * @generated
 */
public class StatusberichteLocalServiceClp implements StatusberichteLocalService {
    ...
    public StatusberichteLocalServiceClp(
    ...
    public de.hska.wi.awp.datasource.infosys.model.Statusberichte addStatusberichte(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(statusberichte) });
        } catch (Throwable t) {
        ...
        return (de.hska.wi.awp.datasource.infosys.model.Statusberichte) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.infosys.model.Statusberichte> getStatusberichtes(
        ...
        return (java.util.List<de.hska.wi.awp.datasource.infosys.model.Statusberichte>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<de.hska.wi.awp.datasource.infosys.model.Statusberichte> findByProjectId(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { project_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
